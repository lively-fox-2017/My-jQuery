$('#email').on('keypress', function(){
  ...
  if (!pattern.test(this.value)) {
    $('#message').html("<img src='../images/false.png' width='12'> Invalid Email Address").css({"color":"red"}).show()
    $("#email").css({"border":"2px solid red","border-radius":"5px","padding":"2px"})
  } else {
    $('#message').html("<img src='../images/true.png' width='12'> Cool Email!").css({"color": "green"}).show()
